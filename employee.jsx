...
function CourseTile({grad, glyph, size=54}){
  return h('div',{className:'course-tile', style:{width:size,height:size,background:`linear-gradient(135deg,${grad[0]},${grad[1]})`}}, glyph);
}
  ...
  return h('div',{className:'page'},
    ...
    h('div',{className:'card', style:{marginBottom:22}},
      ...
      h('div',{className:'next-tier'},'Next tier: ', h('b',null,'Diamond'),'  ·  ',
        h('span',{style:{color:'var(--muted)',fontWeight:600}}, `${E.tierProgress}% there`))
    ),
    // 3 cards
    h('div',{className:'grid cols-3'},
      // streak
      h('div',{className:'card tall streak-card'},
        h('div',{className:'card-title', style:{alignSelf:'flex-start'}},'Streak'),
      ...
      h('div',{style:{display:'flex',flexDirection:'column',gap:22}},
        h('div',{className:'card'},
          ...
          h('div',{className:'course-row'},
            h(CourseTile,{grad:E.continueCourse.tile, glyph:'⚛'}),
            h('div',null,
        ...
        h('div',{className:'card'},
          ...
          h('div',{className:'reco'},
            h(CourseTile,{grad:E.recommended.tile, glyph:'AI', size:46}),
            h('div',null,
      ...
      h('div',{className:'card'},
        ...
        h('div',{style:{display:'flex',flexDirection:'column',gap:14,marginTop:18}},
          TM.recommended.map((c,i)=>h('div',{className:'reco-card',key:i},
            h(CourseTile,{grad:c.tile, glyph:c.glyph}),
            h('div',{className:'body'},
